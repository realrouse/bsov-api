...
const address = "0x26946adA5eCb57f3A1F91605050Ce45c482C9Eb1" //BKC contract address
...
router.get('/frozen', (__, res) => {
 ...
 router.get('/liquidity-eth', (__, res) => {
    const UniswapBkcEthAmountOfEth = 'https://api.etherscan.io/api?module=account&action=tokenbalance&contractaddress=0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2&address=0xfac49a3524a99c90defb63571b2dfff70d12b1e2&tag=latest&apikey=VFXCIKBK33QVIW42AM7153EANCA3YT7Q7V';
 ...
 router.get('/liquidity-bsov', (__, res) => {
    const UniswapBkcEthAmountOfBkc = 'https://api.etherscan.io/api?module=account&action=tokenbalance&contractaddress=0x26946adA5eCb57f3A1F91605050Ce45c482C9Eb1&address=0xfac49a3524a99c90defb63571b2dfff70d12b1e2&tag=latest&apikey=VFXCIKBK33QVIW42AM7153EANCA3YT7Q7V';
